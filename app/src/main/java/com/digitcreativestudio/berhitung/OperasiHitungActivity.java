...
public class OperasiHitungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_operasi_hitung);
    ...
    public void acakSoal(View v) {
        ...
        int rc = (int)(5 * Math.random() + 1);
        nilai_a = ra;
        nilai_b = rb;
        nilai_c = rc;
        displayOperasiHitungA(nilai_a);
        displayOperasiHitungB(nilai_b);
        displayOperasiHitungC(nilai_c);
        displayHasilC("");
     ...
     */
    private void displayOperasiHitungA(int a) {
     ...
     */
    private void displayOperasiHitungB(int b) {
     ...
     * Display question C
     *
     * @param c for c value of question C
     */
    private void displayOperasiHitungC(int c) {
        TextView soalBTextView = (TextView) findViewById(R.id.t_soal_c);
        soalBTextView.setText("" + c);
    }
    ...
    private int cekJawaban() {
        nilai_d = nilai_a + nilai_b * nilai_c;
        return nilai_d;
