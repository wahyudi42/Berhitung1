...
public class MenuTambahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * This button below is used to move into tambah activity
         */
        Button latihan_tambah = (Button) findViewById(R.id.latihan_tambah);
        latihan_tambah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = null;
                i = new Intent(MenuTambahActivity.this, TambahActivity.class);
                startActivity(i);
            }
        });
        loadMateri();
    ...
    private void loadMateri() {
        ...
        materi.setText(getString(R.string.materi_tambah));
    }
}
